...
func (m *MockSecret) Scope() string {
	m.ctrl.T.Helper()
...
func (mr *MockSecretMockRecorder) Scope() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Scope", reflect.TypeOf((*MockSecret)(nil).Scope))
}

// Value mocks base method.
func (m *MockSecret) Value() any {
	m.ctrl.T.Helper()
...
func (mr *MockSecretMockRecorder) Value() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Value", reflect.TypeOf((*MockSecret)(nil).Value))
}
